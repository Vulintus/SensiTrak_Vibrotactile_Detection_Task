...
behavior.session.trial(t).params.vib_dur = ...
    behavior.session.params.vib_pulse_dur;                                  %Copy the vibration pulse duration to the trials structure.
...
behavior.session.trial(t).params.vib_ipi = ...
    round(1000/behavior.session.trial(t).params.vib_rate,3);                %Calculate the vibration inter-pulse period, in milliseconds.
